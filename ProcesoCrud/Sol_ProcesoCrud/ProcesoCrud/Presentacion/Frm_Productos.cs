    ...
    public partial class Frm_Productos : Form
    {
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            if (txtDescripcion_pr.Text == string.Empty || 
                ...
                txtStockactual.Text == string.Empty) // Valida que todos los datos esten correctos
            {
                MessageBox.Show("Falta ingresar datos requeridos (*)", "Aviso del sistema", 
                            MessageBoxButtons.OK, 
                            MessageBoxIcon.Exclamation);
            }
            else // Se guarda la informacion
            {
                string Rpta = "";
        ...
        {
            Reportes.Frm_Rpt_Listado_pr oFrm_Rpt = new Reportes.Frm_Rpt_Listado_pr();
